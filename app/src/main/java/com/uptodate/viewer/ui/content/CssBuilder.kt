...
#mc3k { font-family: inherit; color: ${colors.text}; }

#mc3k table[cellpadding] td[bgcolor],
#mc3k table[cellpadding] tr[bgcolor] td {
...
#mc3k td, #mc3k th { padding: 10px 12px; background-color: ${colors.bg} !important; }
